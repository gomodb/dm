...
func connExecAfter(conn *DmConnection, _ string, args any, updateCount int) {
...
func connQueryAfter(conn *DmConnection, _ string, args any, resultSet *DmRows) {
	if resultSet != nil {
...
func internalAfterStatementExecute(stmt *DmStatement, args any, _ int) {
	nowNano := time.Now().UnixNano()
