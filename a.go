...
func (dm_build_738 *dm_build_697) dm_build_737(dm_build_739 dm_build_1097) (dm_build_740 any, dm_build_741 error) {
...
func (dm_build_751 *dm_build_697) dm_build_750() error {
	...
	switch dm_build_751.dm_build_701.sslEncrypt {
	case 2:
...
func (dm_build_787 *dm_build_697) Dm_build_786(dm_build_788 *DmStatement, dm_build_789 [][]any) (*execRetInfo, error) {
...
func (dm_build_794 *dm_build_697) Dm_build_793(dm_build_795 *DmStatement, dm_build_796 [][]any, dm_build_797 bool) (*execRetInfo, error) {
	var dm_build_798, dm_build_799 int
	var dm_build_800 = len(dm_build_796)
	var dm_build_801 [][]any
	var dm_build_802 = NewExceInfo()
	dm_build_802.updateCounts = make([]int64, dm_build_800)
	var dm_build_803 bool
	for dm_build_798 < dm_build_800 {
		for dm_build_799 = dm_build_798; dm_build_799 < dm_build_800; dm_build_799++ {
			...
			bindData := make([]any, dm_build_795.paramCount)
			dm_build_803 = false
...
func (dm_build_805 *dm_build_697) Dm_build_804(dm_build_806 *DmStatement, dm_build_807 []any, dm_build_808 bool) (*execRetInfo, error) {

	var dm_build_809 = make([]any, dm_build_806.paramCount)
...
func (dm_build_892 *dm_build_697) dm_build_891(dm_build_893 *DmClob, dm_build_894 int, dm_build_895 string, dm_build_896 string) (int, error) {
	...
	for i := range dm_build_903 {
		...
		dm_build_902 = min(dm_build_899-dm_build_901, Dm_build_1089)
...
func (dm_build_908 *dm_build_697) dm_build_907(dm_build_909 *DmBlob, dm_build_910 int, dm_build_911 []byte) (int, error) {
	...
	for i := range dm_build_917 {
		...
		dm_build_916 = min(dm_build_913-dm_build_915, Dm_build_1089)
...
func (dm_build_929 *dm_build_697) dm_build_928(dm_build_930 []any, dm_build_931 []any, dm_build_932 int) bool {
	...
	if binder, ok := dm_build_931[dm_build_932].(iOffRowBinder); ok {
		...
		if lob.canOptimized(dm_build_929.dm_build_701) {
...
func (dm_build_935 *dm_build_697) dm_build_934(dm_build_936 *DmStatement, _ parameter, dm_build_938 int, dm_build_939 iOffRowBinder) error {
	var dm_build_940 = Dm_build_287()
	dm_build_939.read(dm_build_940)
	var dm_build_941 int
